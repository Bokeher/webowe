//zad 2.5
const arr:string[] = ["jabłko", "arbuz", "banan", "gruszka"];
const span:HTMLElement = document.getElementById("array") as HTMLElement;

//a
function getLength() {
    const length = document.getElementById("length") as HTMLElement;
...
// 2.6
const buttons = document.getElementsByTagName("button") as HTMLCollection;
...
//2.7
const elem = document.getElementById("res") as HTMLElement;
const arr2:string[] = ["marchew", "burak", "pietruszka", "kalafior"];
let arr3:string[] = [];
